...
public class SimplePaint extends JApplet {
	...
	static PaintConnector pc;
	SimplePaintPanel content;
	public SimplePaint() {
	...
	public static class SimplePaintPanel extends JPanel implements MouseListener, MouseMotionListener {
		...
		public void mouseDragged(MouseEvent evt) {
			...
			drawline(prevX, prevY, x, y); // Draw the line.
			pc.send(prevX, prevY, x, y);
		...
		public void drawline(int x1, int y1, int x2, int y2){
			graphicsForDrawing.drawLine(x1, y1, x2, y2);
		}
